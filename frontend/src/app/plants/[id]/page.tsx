...
export default function PlantDetailPage() {
  ...
  if (!plant) return <div className="p-8 text-center text-red-500">식물 정보를 불러올 수 없습니다.</div>;
    ...
    <main className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="pt-16 relative">
        <div className="w-full h-64 bg-slate-200">
          <img src={plant.mainImageUrl} alt={plant.name} className="w-full h-full object-cover" />
        </div>
